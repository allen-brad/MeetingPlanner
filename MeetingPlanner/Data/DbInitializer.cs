        ...
        public static void Initialize(MeetingContext context)
        {
            ...
            var meetings = new Meeting[]
            {
                new Meeting{Date=DateTime.Parse("2018-12-02"), Invocation="Brother Grant", Announcements="Ward Party Dec 12th, Tithing Settlement Sign up", Choirister="Sister Musical",
                    Organist ="Sister Talented", BishopricID=1, Presiding ="Bishop Wonderful", WardBusiness ="Tommy Jones advancement", StakeBusiness="none",
                ...
                new Meeting{Date=DateTime.Parse("2018-12-09"), Invocation="Brother Rigby", Announcements="Ward Party Dec 12th", Choirister="Sister Musical", Organist="Sister Talented",
                    BishopricID =2, Presiding ="Bishop Wonderful", WardBusiness="none", StakeBusiness="none",
                    OpenHymn ="212 Far, Far Away on Judea's Plains",
                    SacHymn ="212 Far, Far Away on Judea's Plains",
                    IntHymn ="212 Far, Far Away on Judea's Plains",
                    CloseHymn ="203 Angels We Have Heard on High",
                ...
                new Meeting{Date=DateTime.Parse("2018-12-16"), Invocation="Sister Pratt", Announcements="Great turnout at Ward Party - thanks!", Choirister="Sister Musical", Organist="Sister Talented", BishopricID=2,
                ...
                new Meeting{Date=DateTime.Parse("2018-12-23"), Invocation="Brother Jones", Announcements="none", Choirister="Sister Musical", Organist="Sister Talented", BishopricID=2,
                ...
                new Meeting{Date=DateTime.Parse("2018-12-30"), Invocation="Sister Newday", Announcements="Donations must be received by 12/31 in order to count for 2018", Choirister="Sister Musical", Organist="Sister Talented", BishopricID=5,
                    Presiding ="Bishop Wonderful", WardBusiness="none", StakeBusiness="none",
                    OpenHymn ="212 Far, Far Away on Judea's Plains",
                    SacHymn ="212 Far, Far Away on Judea's Plains",
                    IntHymn ="212 Far, Far Away on Judea's Plains",
